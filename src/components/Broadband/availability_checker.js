        ...
        return (
            <div className='integrated-broadband-wrapper'>
                ...
                <div className='breadcrumb-wrapper integrated-broadband-wrapper'>
                    {this.props.globalState.isMultiJourney ? 
                        <ul>
                            <li className='current'><Link to='/availability_checker'><span>Current provider</span></Link></li>
                            <li className='future'><a href='#/'><span>Quote</span></a></li>
                    ...
                    :
                        <ul>
                            <li className='current'><Link to='/availability_checker'><span>Current provider</span></Link></li>
                            <li className='future'><a href='#/'><span>Package Type</span></a></li>
                            <li className='future'><a href='#/'><span>Your Devices</span></a></li>
                            <li className='future'><a href='#/'><span>Current cost</span></a></li>
                            <li className='future'><a href='#/'><span>Quote</span></a></li>
                            <li className='future'><a href='#/'><span>Package summary</span></a></li>
                            <li className='future'><a href='#/'><span>Apply</span></a></li>
                        </ul>
                ...
                <div className='feature-wrapper'>
                    ...
                    <div className='question-wrapper'>
                        <h2>Just a few questions to help us find the most suitable broadband package for you...</h2>
                        ...
                        <Formik
                            ...
                            validate={values => {
                                ...
                                if (parseInt(values.years) === 0 && parseInt(values.months) === 0 && parseInt(values.providerId) > 0) {
                                    errors.totalMonths = "Required";
                                } 
                                if (!Number.isInteger(values.years) && !Number.isInteger(values.months) && parseInt(values.providerId) > 0) {
                                    errors.totalMonths = "Required";
                                } 
                                if (!this.props.globalState.isBtJourney) {
                                    if (!values.aerial) { errors.aerial = "Required"; }
                                    if (!values.canHaveVirgin) { errors.canHaveVirgin = "Required"; }
                                }
                                return errors;
                            }}
                        >
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className='form-row'>
                                            ...
                                            {!this.state.providersLoaded
                                                ? <ClipLoader size={1.35} sizeUnit='rem' color='#203a54'/> 
                                                : <select id='providerId' name='providerId'  value={props.values.providerId || ''} onChange={props.handleChange} onBlur={props.handleBlur}
                                                    // style={{
                                                    //     borderColor:
                                            ...
                                            {errors.providerId && touched.providerId && (
                                                <div className="validation_text">{errors.providerId}</div>
                                            )}
                                        </div>
                                        { values.providerId > 0 && (
                                        <div className='form-row multi'>
                                            
                                            <label>How long have you been with this provider?</label>
                                            <div className='multi-field-row'>
                                                <input
                                                    ...
                                                    style={{
                                                        borderColor:
                                                            props.errors.totalMonths && "tomato"
                                                    }}
                                                />
                                                <label>&nbsp;Years&nbsp;&nbsp;</label>
                                                ...
                                                {errors.totalMonths && (
                                                    <div className="validation_text">{errors.totalMonths}</div>
                                                )}
                                        ...
                                        <div className='form-row multi radio'>
                                            ...
                                            <div className='multi-field-row'>
                                                <label htmlFor='aerialYes' className='radio-label'>
                                                    <input id='aerialYes' name='aerial' type='radio' value="true" onChange={() => setFieldValue("aerial", "true")} checked={values.aerial === "true"} />
                                                    Yes</label>
                                                <label htmlFor='aerialNo' className='radio-label'>
                                                    <input id='aerialNo' name='aerial' type='radio' value="false" onChange={() => setFieldValue("aerial", "false")} checked={values.aerial === "false"} />
                                                    No</label>
                                                {errors.aerial && (
                                                    <label className="validation_text">{errors.aerial}</label>
                                                )}
                                            </div>
                                        </div>
                                        }
                                        ...
                                        <div className='form-row multi radio'>
                                            ...
                                            <div className='multi-field-row'>
                                                <label htmlFor='canHaveVirginYes' className='radio-label'>
                                                    <input id='canHaveVirginYes' name='canHaveVirgin' type='radio' value="true" onChange={() => setFieldValue("canHaveVirgin", "true")} checked={values.canHaveVirgin === "true"} />
                                                    Yes</label>
                                                <label htmlFor='canHaveVirginNo' className='radio-label'>
                                                    <input id='canHaveVirginNo' name='canHaveVirgin' type='radio' value="false" onChange={() => setFieldValue("canHaveVirgin", "false")} checked={values.canHaveVirgin === "false"} />
                                                    No</label>
                                                {errors.canHaveVirgin && (
                                                    <label className="validation_text">{errors.canHaveVirgin}</label>
                                                )}
                                            </div>
                                        </div>
                                        }
                                        ...
                                        {!this.state.formStep1 && 
                                            <button type="submit" className='link-btn' disabled={isSubmitting}>
                                                Continue
                                            </button>
                                        }
                ...
                {this.props.globalState.isMultiJourney && this.state.formStep1 && 
                    ...
                    {!this.state.formStep2 && 
                        <button type="submit" onClick={this.validateUsage} className='link-btn'>
                            Continue
                        </button>
                    }
                </div>
            ...
            {this.props.globalState.isMultiJourney && this.state.formStep2 &&
                ...
                {!this.state.formStep3 && 
                    <button type="submit" onClick={this.validateStep} className='link-btn'>
                        Continue
                    </button>
                }
                </div>
